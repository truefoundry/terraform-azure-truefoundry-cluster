...
| <a name="input_control_plane_enable_auto_scaling"></a> [control\_plane\_enable\_auto\_scaling](#input\_control\_plane\_enable\_auto\_scaling) | Enable auto scaling for the control plane node pool | `bool` | `true` | no |
...
| <a name="input_control_plane_node_count"></a> [control\_plane\_node\_count](#input\_control\_plane\_node\_count) | Node count for the control plane node pool. Used only when autoscaling is disabled | `number` | `2` | no |
| <a name="input_control_plane_node_max_count"></a> [control\_plane\_node\_max\_count](#input\_control\_plane\_node\_max\_count) | Max count in the control plane node pool | `number` | `4` | no |
| <a name="input_control_plane_node_min_count"></a> [control\_plane\_node\_min\_count](#input\_control\_plane\_node\_min\_count) | Min count in the control plane node pool | `number` | `0` | no |
| <a name="input_control_plane_os_disk_size_gb"></a> [control\_plane\_os\_disk\_size\_gb](#input\_control\_plane\_os\_disk\_size\_gb) | OS disk size of the control plane node pool in GB | `number` | `100` | no |
...
| <a name="input_critical_enable_auto_scaling"></a> [critical\_enable\_auto\_scaling](#input\_critical\_enable\_auto\_scaling) | Enable auto scaling for the critical node pool | `bool` | `true` | no |
| <a name="input_critical_node_count"></a> [critical\_node\_count](#input\_critical\_node\_count) | Node count for the critical node pool. Used only when autoscaling is disabled | `number` | `2` | no |
| <a name="input_critical_node_max_count"></a> [critical\_node\_max\_count](#input\_critical\_node\_max\_count) | Max count in the critical node pool | `number` | `2` | no |
| <a name="input_critical_node_min_count"></a> [critical\_node\_min\_count](#input\_critical\_node\_min\_count) | Min count in the critical node pool | `number` | `0` | no |
...
| <a name="input_critical_os_disk_size_gb"></a> [critical\_os\_disk\_size\_gb](#input\_critical\_os\_disk\_size\_gb) | OS disk size of the critical node pool in GB | `number` | `100` | no |
...
| <a name="input_kubernetes_version"></a> [kubernetes\_version](#input\_kubernetes\_version) | Version of the kubernetes engine | `string` | `"1.34"` | no |
